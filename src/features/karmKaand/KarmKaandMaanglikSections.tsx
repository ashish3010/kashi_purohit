...
export function KarmKaandMaanglikSections({ copy }: { copy: SiteCopy }) {
  const sectionEyebrow = copy.pages.karmKaand.sectionEyebrow;
...
export function KarmKaandMaanglikIntro({ copy }: { copy: SiteCopy }) {
